...
// ✅ CAMBIO CRÍTICO: Busca el archivo en la carpeta 'views'
$archivo = 'views/estudiantes.txt';
$mensaje = "";
$tipo_mensaje = "info";

if (file_exists($archivo)) {
    // ✅ LÍNEA MÁGICA: Convertir el archivo a UTF-8 antes de leerlo (Evita los símbolos raros)
    $contenido = file_get_contents($archivo);
    $contenido = mb_convert_encoding($contenido, 'UTF-8', 'auto');
    file_put_contents($archivo, $contenido);

    // Ahora leemos el archivo ya convertido
    ...
    $mensaje = "Error: No se encontró el archivo 'views/estudiantes.txt' en la carpeta del proyecto.";
    $tipo_mensaje = "error";
}
?>
...
<div class="contenedor">
    ...
    <!-- ✅ Corregido para redirigir a la raíz correcta -->
